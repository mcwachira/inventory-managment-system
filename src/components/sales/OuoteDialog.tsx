...
export const QuoteDialog = ({
  ...
  const [formData, setFormData] = useState({
    ...
    status: "draft",
    notes: "",
    terms: "Quote valid for 30 days. Prices subject to change without notice.",
  ...
  const handleConvertToOrder = () => {
    const { subtotal, tax, total } = calculateTotals();
    console.log("Converting quote to sales order:", {
      ...formData,
      subtotal,
      tax,
      total,
    ...
    toast({
      ...
      description: "Quote is being converted to a sales order.",
    });
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            {quoteToEdit ? "Edit Quote" : "Create Quote"}
          </DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-between">
            <div className="space-x-2">
              {quoteToEdit && quoteToEdit.status === "accepted" && (
                <Button
                  type="button"
